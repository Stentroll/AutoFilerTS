...
window.onload = function () {
    ...
    var btnSwitchTable = document.getElementById('btnSwitchTable');
    var btnLoadTestData = document.getElementById('btnLoadTestData');
    CreateFilterChecks();
...
function PopulateTextArea() {
    ...
    var AFtextBox = document.getElementById("ruletextarea");
    var BFtextBox = document.getElementById("bftextarea");
...
function SwitchTable() {
    var AFtbl = document.getElementById("af-table-div");
    var BFtbl = document.getElementById("bf-table-div");
    var btnSwitchTable = document.getElementById("btnSwitchTable");
    if (AFview) {
        AFview = false;
        AFtbl.hidden = true;
