...
var afTableDiv: HTMLDivElement;
var bfTableDiv: HTMLDivElement;
var btnSwitchTable: HTMLButtonElement;
var ruleTextArea: HTMLTextAreaElement
var bfTextArea: HTMLTextAreaElement;

var btnClearFilters: HTMLButtonElement;
var btnCheckShowAll: HTMLInputElement;
var btnCheckHideAll: HTMLInputElement;
...
window.onload = () => {    
    ...
    bfTextArea = <HTMLTextAreaElement>document.getElementById("bftextarea");
    btnCheckHideAll = <HTMLInputElement>document.getElementById("btnCheckHideAll");
...
function ShowHideMultilineFields(): void {
    var checkboxElementArray = document.getElementsByClassName("fieldcheck");
...
function FilterAFonRuleName(rule) {
    var tmp: string = rule.name.toLowerCase();
...
function CreateFilterChecks() {
    ...
    var newDiv: HTMLDivElement;
    var newCheck: HTMLInputElement;
    var tag: HTMLElement;
